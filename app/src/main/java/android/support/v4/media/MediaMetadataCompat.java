...
public final class MediaMetadataCompat implements Parcelable {
  ...
  static  {
    ...
    CREATOR = new Parcelable.Creator<MediaMetadataCompat>() {
        public MediaMetadataCompat a(Parcel param1Parcel) { return new MediaMetadataCompat(param1Parcel); }
        
        public MediaMetadataCompat[] a(int param1Int) { return new MediaMetadataCompat[param1Int]; }
      };
  }
  
  MediaMetadataCompat(Parcel paramParcel) { this.b = paramParcel.readBundle(); }
  ...
  public void writeToParcel(Parcel paramParcel, int paramInt) { paramParcel.writeBundle(this.b); }
}


/* Location:              C:\Users\Siyam\Desktop\Home automation with java source files\Decompile tools\New folder\dex2jar-0.0.9.15-master\classes_dex2jar.jar!\android\support\v4\media\MediaMetadataCompat.class
